...
ALTER TABLE `bookcar` ADD `status` VARCHAR(200) NOT NULL AFTER `sum_car`;
ALTER TABLE `bookcar` ADD `route` VARCHAR(200) NOT NULL AFTER `car_station`;
ALTER TABLE `bookcar` ADD `route` VARCHAR(200) NOT NULL AFTER `route`;
ALTER TABLE `bookcar` ADD `special_requirement` VARCHAR(200) NOT NULL AFTER `special_requirement`;
